...
export function MonthSelector({ months }: MonthSelectorProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div className="absolute left-0 right-0 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 sm:min-w-[340px] top-full mt-2 z-50 rounded-2xl p-4 border border-white/10 shadow-2xl" style={{ background: 'rgb(10, 14, 23)' }}>
          {years.map(year => (
